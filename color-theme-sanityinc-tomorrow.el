...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (whitespace-hspace ((,class (:background ,current-line :foreground ,comment))))
     (whitespace-indentation ((,class (:background ,current-line :foreground ,comment))))
     (whitespace-line ((,class (:background ,current-line :foreground ,red))))
     (whitespace-newline ((,class (:background ,current-line :foreground ,comment))))
     (whitespace-space ((,class (:background ,current-line :foreground ,comment))))
     (whitespace-space-after-tab ((,class (:background ,current-line :foreground ,yellow))))
     (whitespace-space-before-tab ((,class (:background ,current-line :foreground ,red))))
     (whitespace-tab ((,class (:background ,current-line :foreground ,comment))))
     (whitespace-trailing ((,class (:background ,current-line :foreground ,red))))
