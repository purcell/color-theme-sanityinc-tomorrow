  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (org-block-begin-line (:background ,contrast-bg :foreground ,comment :slant italic :underline t))
      (org-block-end-line (:background ,contrast-bg :foreground ,comment :slant italic :overline t))
