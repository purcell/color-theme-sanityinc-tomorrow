  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (whitespace-indentation (:background ,background :foreground ,comment))
      (whitespace-line (:background ,background :foreground ,red))
      (whitespace-newline (:background ,background :foreground ,comment))
      (whitespace-space (:background ,background :foreground ,comment))
