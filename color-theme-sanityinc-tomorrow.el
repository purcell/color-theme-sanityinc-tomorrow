  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (bmkp-light-autonamed (:foreground ,contrast-bg :background ,aqua))
      (bmkp-light-autonamed-region (:foreground ,contrast-bg :background ,red))
      ...
      (bmkp-light-non-autonamed (:foreground ,background :background ,purple))
      (bmkp-light-non-autonamed-region (:foreground ,background :background ,red))
