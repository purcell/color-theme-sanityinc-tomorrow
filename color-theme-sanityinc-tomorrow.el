  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      ;; ediff
      (ediff-current-diff-A (:foreground ,background :background ,green))
      (ediff-current-diff-Ancestor (:foreground ,background :background ,yellow))
      (ediff-current-diff-B (:foreground ,background :background ,green))
      (ediff-current-diff-C (:foreground ,background :background ,green))
      ...
      (ediff-fine-diff-A (:foreground ,background :background ,red))
      (ediff-fine-diff-Ancestor (:foreground ,background :background ,orange))
      (ediff-fine-diff-B (:foreground ,background :background ,red))
      (ediff-fine-diff-C (:foreground ,background :background ,red))
      (ediff-odd-diff-A (:foreground ,background :background ,comment))
      (ediff-odd-diff-Ancestor (:foreground ,background :background ,aqua))
      (ediff-odd-diff-B (:foreground ,background :background ,comment))
      (ediff-odd-diff-C (:foreground ,background :background ,comment))
      ...
      (magit-diff-added (:foreground ,background :background ,green))
      ...
      (magit-diff-hunk-heading-highlight (:foreground ,foreground :background ,highlight :weight bold))
      (magit-diff-lines-heading (:foreground ,yellow :background ,red))
      (magit-diff-removed (:foreground ,background :background ,red))
      (magit-diff-removed-highlight (:foreground ,red :background ,highlight :weight bold))
